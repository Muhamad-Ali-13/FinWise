            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4 lg:space-x-6">
                ...
                @can('role-A')
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 bg-gray-800 hover:bg-gray-700 hover:text-white focus:outline-none transition ease-in-out duration-300">
                                <div>Master</div>
                                <div class="ms-1">
                ...
                @canany(['role-A', 'role-U'])
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('tabungan.index')"
                                class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                                {{ __('Tabungan') }}
                            </x-dropdown-link>
                        </x-slot>
                ...
                @can('role-A')
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('laporanPemasukan.index')"
                                class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                                {{ __('Pemasukan') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('laporanPengeluaran.index')"
                                class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                                {{ __('Pengeluaran') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('laporanTabungan.index')"
                                class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                                {{ __('Tabungan') }}
                            </x-dropdown-link>
                        </x-slot>
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')"
                        class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700 hover:text-white transition duration-200">
                    {{ __('Profile') }}
