        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4 lg:space-x-6">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('laporanPemasukan.index')" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                            {{ __('Pemasukan') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('laporanPengeluaran.index')" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                            {{ __('Pengeluaran') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('laporanTabungan.index')" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition duration-200">
                            {{ __('Tabungan') }}
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
