                    ...
                    <div class="w-full bg-gray-100 p-4 rounded-xl">
                        ...
                        <form action="{{ route('target_pembayaran.store') }}" method="post">
                            ...
                            <div class="mb-5">
                                ...
                                <input name="periode" type="text" id="base-input"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
...
<script>
    const editSourceModal = (button) => {
        ...
        let url = "{{ route('target_pembayaran.update', ':id') }}".replace(':id', id);
    ...
    const paketDelete = async (id, targetP) => {
        let tanya = confirm(`Apakah anda yakin untuk menghapus targetP ${targetP} ?`);
        if (tanya) {
            await axios.post(`/targetP/${id}`, {
                    '_method': 'DELETE',
